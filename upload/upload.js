...
var markUpload = function (static_url, handel) {
    ...
    return function (req, res, next) {
        if (req.query.action === 'config') {
            ...
            busboy.on('file', function (fieldname, file, filename, encoding, mimetype) {
                req.markUpload = {};
                req.markUpload.fieldname = fieldname;
                req.markUpload.file = file;
                req.markUpload.filename = filename;
                req.markUpload.encoding = encoding;
                req.markUpload.mimetype = mimetype;
